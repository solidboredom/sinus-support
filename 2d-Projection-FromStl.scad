...
//STEP3: export the Projected part as SVG (File-Export->exposrt as SVG)
//and save the exported .svg file
//in the same folder where the sinussupport.js and all other files are located 